...
export default function AboutPage() {
  return (
    <main className="bg-black font-sans p-5 min-h-screen">
      {/* Back Home */}
      <Link
        href="/"
      ...
      {/* About Me Section */}
      <section className="mt-5 flex flex-col md:flex-row gap-10 max-w-7xl mx-auto">
        {/* Image on the left */}
        <div
        ...
        <div className="flex-1 flex flex-col">
          ...
          <p className="text-white text-lg md:text-xl leading-relaxed">
            ...
            design. Always exploring new tools and improving step by step, with
            the goal of building simple, creative, and meaningful digital
            experiences.
          </p>

          {/* Skills BELOW paragraph */}
          <h2 className="text-white text-3xl font-bold mt-6 mb-4 hover:underline">
            Skills
          </h2>
          <div className="flex flex-wrap gap-6 text-white italic">
            {["HTML", "CSS", "Tailwind CSS", "JavaScript", "UI/UX Design","React","next"].map(
              (skill) => (
                <span
                  key={skill}
                  className="bg-purple-600 px-3 py-1 rounded-full text-sm hover:border-purple-500 transition-transform duration-300 hover:scale-105 cursor-pointer"
                >
                  {skill}
                </span>
              )
