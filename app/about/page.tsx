        ...
        <section className="mt-5 flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex flex-wrap gap-3 text-white italic">
              ...
              <span className="bg-purple-600 px-3 py-1 rounded-full text-sm hover:border-purple-500 transition-transform duration-300 hover:scale-105 cursor-pointer">React</span>
              <span className="bg-purple-600 px-3 py-1 rounded-full text-sm hover:border-purple-500 transition-transform duration-300 hover:scale-105 cursor-pointer">Next.js</span>
            </div>
          </div>
        </section>
      </main>
